...
export const RestaChampions = () => {
  ...
  const generateNumbers = () => {
    ...
    const n1 = Math.floor(Math.random() * maxNumber) + maxNumber
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-500 to-orange-600 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-2xl w-full">
        ...
        <div className="text-center mb-6">
          <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-600 mb-2">
            ➖ Resta Veloz
          </h1>
          <p className="text-gray-600">¡Resuelve las restas lo más rápido posible!</p>
        </div>
          ...
          <>
            ...
            <div className="flex gap-4">
              <button
                onClick={checkAnswer}
                disabled={!userAnswer}
                className="flex-1 bg-gradient-to-r from-red-600 to-orange-600 text-white font-bold py-4 rounded-xl hover:from-red-700 hover:to-orange-700 transition transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                ✓ Verificar
              </button>
          ...
          <div className="text-center">
            ...
            <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-6 mb-6">
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-white rounded-xl p-4">
                  <div className="text-3xl font-bold text-orange-600">Nv.{level}</div>
            ...
            <div className="flex gap-4">
              <button
                onClick={restartGame}
                className="flex-1 bg-gradient-to-r from-red-600 to-orange-600 text-white font-bold py-4 rounded-xl hover:from-red-700 hover:to-orange-700 transition transform hover:scale-105"
              >
                🔄 Jugar de Nuevo
              </button>
