...
export const RestaChampions = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-red-400 via-orange-500 to-yellow-600 py-8 px-4'>
          ...
          <div className='bg-white rounded-2xl shadow-2xl p-8'>
            <div className='text-center mb-8'>
              ...
              <input
                ...
                className='w-full max-w-xs text-center text-4xl font-bold border-4 border-orange-300 rounded-lg p-4 focus:outline-none focus:border-orange-500'
                placeholder='?'
                autoFocus
                disabled={gameOver}
              />
            ...
            <button
              ...
              className='w-full bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold py-4 rounded-lg text-xl hover:from-orange-600 hover:to-red-600 transition disabled:opacity-50 disabled:cursor-not-allowed'
            >
              Verificar Respuesta
            </button>
